...
#List1
db_warm_all=subset(db_warm, dates<2016)
db_warm_pre_2006=subset(db_warm,dates<=2006)
db_warm_post_2006=subset(db_warm,dates>2006&dates<2016)
db_cold_all=subset(db_cold,dates<2016)
db_cold_pre_2006=subset(db_cold,dates<=2006)
db_cold_post_2006=subset(db_cold,dates>2006&dates<2016)
...
#List2
db_warm_all=subset(db_warm,sp_data_frame %in% list2  &dates<2016)
db_warm_pre_2006=subset(db_warm,sp_data_frame %in% list2  &dates<=2006)
db_warm_post_2006=subset(db_warm,sp_data_frame %in% list2  &dates>2006&dates<2016)
db_cold_all=subset(db_cold,sp_data_frame %in% list2  &dates<2016)
db_cold_pre_2006=subset(db_cold,sp_data_frame %in% list2 &dates<=2006)
db_cold_post_2006=subset(db_cold, sp_data_frame %in% list2 &dates>2006&dates<2016)
