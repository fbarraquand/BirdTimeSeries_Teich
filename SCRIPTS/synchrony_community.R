...
sp_to_ignore=c("Anas discors","Anas americana","Calidris melanotos","Calidris pusilla","Calidris ruficollis", "Calidris fuscicollis", "Calidris himantopus", "Burhinus oedicnemus","Phalaropus lobatus","Charadrius alexandrinus","Haematopus ostralegus","Calidris maritima","Aythya nyroca","Bucephala clangula","Melanitta nigra","Mergus serrator","Clangula hyemalis","Alopochen aegyptiaca", "Aix galericulata","Cygnus atratus","Tadorna ferruginea","Branta leucopsis","Anser fabalis","Anser albifrons","Cygnus cygnus","Mergus merganser","Anser brachyrhynchus")#,"Alcedo atthis","Netta rufina","Falco peregrinus","Himantopus himantopus","Numenius phaeopus","Tringa ochropus","Charadrius dubius")

#There are now 57 species in the frequent ones because Alcedo atthis only appears in 2007, Netta rufina and Falco peregrinus disappear after 2006
...
#filename_pdf=paste("Gross_freq_new_",end_bio,"_",end_nor,"_test_with",anrands,"rand.pdf",sep="")
filename_pdf=paste("Gross_freq_new_",end_bio,"_",end_nor,"_test_with",anrands,"rand_wtfwithfreq.pdf",sep="")
