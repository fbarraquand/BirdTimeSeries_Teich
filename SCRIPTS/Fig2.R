...
#### 2019/06/25: Corrected an error on standard deviation. They were computed under H0 (on permutated time series) and were associated to the observed value (errobars were built around the observed value with the sd from rands)
...
if(box_index){
pdf("Submission_JAE/Revisions/Gross_freq_boxplot.pdf",width=11,height=7,family="Times")
}else{
pdf("Submission_JAE/Revisions/Gross_freq_line.pdf",width=11,height=7,family="Times")
}
...
if(box_index){
pdf("Submission_JAE/Revisions/Fig2_new2_JAE_boxplot.pdf",width=11,height=14)
}else{
pdf("Submission_JAE/Revisions/Fig2_new2_JAE_line.pdf",width=11,height=14)
}
