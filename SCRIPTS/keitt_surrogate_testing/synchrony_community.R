...
#The aim is to compare synchrony indices at different taxonomic levels. This script is based on Fig5.R, to compute the Gross and Keitt indices on the community of the most frequent birds
...
amethod_w="shift" #method to build the surrogates for the Gross index
anrands=1000
biomass=F
if(biomass){
end_bio="biomasses"
