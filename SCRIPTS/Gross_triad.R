...
if(biomass){
        db_warm=read.csv("IN/warmseason_biomasses_asdataframe_summed_v2_wtoutrarespecies.csv",sep=";",header=T)
        db_cold=read.csv("IN/coldseason_biomasses_asdataframe_summed_v2_wtoutrarespecies.csv",sep=";",header=T)        
}else{
